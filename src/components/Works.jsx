  ...
  return (
    <>
      ...
      <div className=' w-full flex'>
        ...
        >
          Following projects showcases my skills and experience through real-world examples of my work. Each project is briefly described with
      ...
      <div className=' mt-20 flex flex-wrap gap-7'>
        {projects.map((projcect, index) => {
          <ProjcectCard key={`project-${index}`} index={index} {...projcect} />
        })}
      </div>
    </>
  )
